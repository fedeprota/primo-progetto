...
- Dopo aver pushato (o fatto upload) i file su GitHub, vai su: https://github.com/fedeprota/primo-progetto/settings/pages
	- Nella sezione "Build and deployment" seleziona `gh-pages` come branch e `/ (root)` come folder, poi salva.
	- Dopo qualche minuto il sito sarà disponibile a: `https://fedeprota.github.io/primo-progetto/`
